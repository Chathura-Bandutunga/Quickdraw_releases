...
<img src="generated/examples/laser_lock.svg" alt="A laser lock diagram" width="720">
...
<sub>These pages are published from the Quickdraw source repository on
each release, and the symbol reference is generated from the code that
draws the symbols. Editing them here would be overwritten by the next
release — please open an issue instead.</sub>
